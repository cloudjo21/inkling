...
class RegisterItemAggrInfoSchema(RegisterSchema):
    def __init__(self, service_config, task_config):
        super(RegisterItemAggrInfoSchema, self).__init__(service_config, task_config)
...
if __name__ == "__main__":
    ...
    for deploy_env in deploy_envs:
        ...
        task_config = get_my_task(
            ...
            context=None, 
            dag_id="dag_load_item_aggr_info", 
            task_id="register_item_aggr_info_schema"
        )
        RegisterItemAggrInfoSchema(service_config, task_config)()
