...
class AliasIndexItemUserAggrInfo(AliasIndex):
    def __init__(self, service_config, task_config):
        super(AliasIndexItemUserAggrInfo, self).__init__(service_config, task_config)
...
if __name__ == "__main__":
    ...
    for deploy_env in deploy_envs:
        ...
        task_config = get_my_task(
            ...
            task_id="alias_index_item_user_aggr_info"
        )
        AliasIndexItemUserAggrInfo(service_config, task_config)()
